...
class CircuitManager:
    ...
    def simulate(self, simulator, shots):
    ...
    def printEntanglementTable(self, cutDiagonal=True, cutRepeats=True, cutEmpty = True, colorize=True, tol = 0.05):
        states = expand(self.counts)
    ...
    def printEntanglements(self, tol = 0.05):
        states = expand(self.counts)
